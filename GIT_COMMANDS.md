...
#example
git clone github.com-efcanchari:efcanchari/caltech-jenkins-project-02.git
```
...
#example
git remote set-url origin git@github.com-efcanchari:efcanchari/caltech-jenkins-project-02.git
```